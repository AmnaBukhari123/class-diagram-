...
class Customer(Person):
    def __init__(self, name, phone_number, cnic, address, customer_id, subscription_id, vehicle_no_plate, car_model):
    ...
    def __str__(self) -> str:
        return f"{super().__str__()}, Customer ID: {self.customer_id}, Subscription ID: {self.subscription_id}, Vehicle No Plate: {self.vehicle.vehicle_no_plate}"
